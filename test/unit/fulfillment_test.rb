...
class FulfillmentTest < ActiveSupport::TestCase
  ...
  test "fulfill order with multiple line items" do
    assert Fulfillment.fulfill(1,"myshop1",[18],"1D","123456789")
  end

  test "fulfill individual line item" do
    assert Fulfillment.fulfill(1,"myshop1",[18],"1D","123456789",[30])
  end

  test "invalid shipping method does not validate" do
    assert_equal false, Fulfillment.fulfill(1,"myshop1",[18],"Invalid Shipping","123456789",[30])
  end
end